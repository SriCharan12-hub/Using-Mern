...
const UserDashboard = ({ showConfirm, setShowConfirm }) => {
  ...
  const effectiveShowConfirm =
    typeof showConfirm === "boolean" ? showConfirm : localShowConfirm;
  const effectiveSetShowConfirm =
    typeof setShowConfirm === "function" ? setShowConfirm : setLocalShowConfirm;
    ...
    <div className={styles["dashboard-page"]}>
      <div className={styles["sidebar"]}>
        ...
        <nav className={styles["nav-menu"]}>
          ...
          <a
            className={`${styles["nav-item"]} ${
              activeTab === "userdetails" ? styles["active"] : ""
            }`}
          ...
          <a
            className={`${styles["nav-item"]} ${
              activeTab === "userfeedback" ? styles["active"] : ""
            }`}
        ...
        >
          ...
          >
            <path
              d="M17 16L21 12L17 8M21 12H9M11 20H4C3.44772 20 3 19.5523 3 19V5C3 4.44772 3.44772 4 4 4H11"
              stroke="#7f8c8d"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
