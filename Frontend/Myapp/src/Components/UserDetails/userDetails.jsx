...
const UserDetails = () => {
    ...
    return (
        <div className="user-details-page">
            {/* <button className='back-btn' onClick={() => navigate('/userdashboard')}>Back</button> */}
                ...
                <div className="update-password-card">
                    ...
                    <form onSubmit={handleUpdate} className="update-form">
                        ...
                        {error && <p className="message1 error-message1">{error}</p>}
                            {successMessage && <p className="message1 success-message1add">{successMessage}</p>}
                            <button type="submit" className="update-btn1">Update Password</button>
